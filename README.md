...
- A DAW (digital audio workstation). There is no correct DAW to use. These all have different workflows, each with their own pros and cons, so download the free demos and choose what you like the most.
  - My personal favorites (I mainly use the top two): 
    - [REAPER](https://reaper.fm) (Mac, Windows, Linux) - My go-to for mixing, mastering, and recording. Very cheap ($60), but just as powerful as any of the others. It's also the most customizable/scriptable DAW (you can create keyboard macros and scripts for just about everything, and you can even code your own audio processing plugins!) Currently I use both this and Bitwig, but I might switch to just REAPER in the future if I can set everything up the way I like it.
      - Part of the cheap price comes from the fact that, unlike the others listed here, REAPER doesn't come with many high-quality plugins (which you'll need for mixing and mastering). _However_, the other essential tools listed here (Komplete Start and iZotope Neutron/Ozone) will make up for this.
...
- Free virtual instruments and guitar amps: [Komplete Start](https://www.native-instruments.com/en/products/komplete/bundles/komplete-start/) by Native Instruments
  ...
  - If this doesn't have enough instruments for you, there's also the free [Spitfire Labs instruments](https://labs.spitfireaudio.com).
